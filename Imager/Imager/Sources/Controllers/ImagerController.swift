...
public protocol ImagerControllerPageDelegate: class {
    func imagerController(_ controller: ImagerController, didMoveToPage page: Int)
}

public protocol ImagerControllerDismissalDelegate: class {
...
open class ImagerController: UIViewController {
    ...
    open fileprivate(set) var currentPage = 0 {
        didSet {
            ...
            pageDelegate?.imagerController(self, didMoveToPage: currentPage)
    ...
    open weak var pageDelegate: ImagerControllerPageDelegate?
    open weak var dismissalDelegate: ImagerControllerDismissalDelegate?
...
extension ImagerController: ImagerHeaderViewDelegate {
    ...
    func headerView(_ headerView: ImagerHeaderView, didPressCloseButton closeButton: UIButton) {
        ...
        presented = false
        dismissalDelegate?.imagerControllerWillDismiss(self)
